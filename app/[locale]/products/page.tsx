  ...
  const products = [
    {
      id: "compressor",
      title: "COMPRESSOR",
      brand: "FIMA, NEUMAN & ESSER, CASTANET, KB DELTA, WTQ",
    ...
    },
    {
      id: "mixer",
      title: "MIXER",
      brand: "SPXFLOW (Lightnin, Plenty, Philadelphia, Stelzer)",
    ...
    },
    {
      ...
      brand: "Turbolink, Samyoung Filtech",
      description: t("products.categories.bearingLubrication.description"),
      features: [
        t("products.categories.bearingLubrication.features.0"),
        t("products.categories.bearingLubrication.features.1"),
