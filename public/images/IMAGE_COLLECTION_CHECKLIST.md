...
- [x] **tjg-huchems-logo.png** - TJG Huchems ✅ (2025-12-18)
  - 📁 위치: public/images/clients/
...
- [x] **Piston** (4개) ✅ (2025-12-18)
  - piston_1.jpg, piston_2.jpg, piston_3.jpg, piston_4.jpg
  - 📁 위치: public/images/ (루트)

- [x] **Piston Rod** (5개) ✅ (2025-12-18)
  - piston-rod_1.jpg ~ piston-rod_5.jpg
  - 📁 위치: public/images/ (루트)

- [x] **Piston Ring** (2개) ✅ (2025-12-18)
  - Piston-ring_1.jpg, Piston-ring_2.jpg
  - 📁 위치: public/images/ (루트)

- [x] **Rider Ring** (3개) ✅ (2025-12-18)
  - Rider-ring_1.jpg, Rider-ring_2.jpg, Rider-ring_3.jpg
  - 📁 위치: public/images/ (루트)

- [x] **Crosshead** (4개) ✅ (2025-12-18)
  - Crosshead_1.jpg ~ Crosshead_4.jpg
  - 📁 위치: public/images/ (루트)

- [x] **Cylinder Liner** (2개) ✅ (2025-12-18)
  - cylinder-liner_1.jpg, cylinder-liner_2.jpg
  - 📁 위치: public/images/ (루트)

- [x] **Packing** (7개) ✅ (2025-12-18)
  - Oil-Scraper-Packing_1.jpg ~ Oil-Scraper-Packing_4.jpg
  - Packing-Cup&Packing-Ring_1.jpg ~ Packing-Cup&Packing-Ring_4.jpg (실제 3개)
  - 📁 위치: public/images/ (루트)

- [x] **Valve Assembly & Internal Parts** (3개) ✅ (2025-12-18)
  - Valve-Assy&Internal-Parts_1.jpg, Valve-Assy&Internal-Parts_2.png, Valve-Assy&Internal-Parts_3.png
  - 📁 위치: public/images/ (루트)

- [x] **Valve Repair Kits** (1개) ✅ (2025-12-18)
  - Valve-Repair-Kits_1.PNG
  - 📁 위치: public/images/ (루트)

- [x] **Spring** (1개) ✅ (2025-12-18)
  - spring_1.PNG
  - 📁 위치: public/images/ (루트)
...
- [ ] **raon-logo.png** - 라온토탈솔루션 로고 ⏳
  - 📥 출처: 회사 내부 자료 (마케팅팀 요청)
  - 📐 권장 크기: 200x100px (투명 배경 PNG)
  - 📁 저장 위치: public/images/company/
  - ⚠️ **필수**: Header, Footer, Organization Schema에서 사용

- [ ] **ceo.jpg** - CEO 사진 ⏳
  - 📥 출처: 회사 내부 자료
  - 📐 권장 크기: 400x400px (정사각형) 또는 600x800px (세로)
  - 📁 저장 위치: public/images/company/
  - 💡 COMPANY 페이지 CEO 인사말 섹션에서 사용
...
## 🎨 OG (Open Graph) 이미지 (13개) ⏳ 디자이너 협업 필요

### SEO용 소셜 미디어 공유 이미지 (1200x630px)

**📖 제작 가이드:** `docs/OG_IMAGE_GUIDE.md` 참조

### Phase 1 (우선 제작) - 3개
- [ ] **main-og.jpg** - 메인 페이지
- [ ] **compressor-og.jpg** - Compressor 제품
- [ ] **oil-refinery-og.jpg** - 정유·석유화학 산업

### Phase 2 (2차 제작) - 7개
- [ ] **mixer-og.jpg** - Mixer 제품
- [ ] **motor-og.jpg** - Motor 제품
- [ ] **pump-og.jpg** - Pump 제품
- [ ] **bearing-og.jpg** - Bearing 제품
- [ ] **shipbuilding-og.jpg** - 조선 산업
- [ ] **cylinder-liner-og.jpg** - Cylinder Liner 제품
- [ ] **oil-purifier-og.jpg** - Oil Purifier 제품

### Phase 3 (3차 제작) - 3개
- [ ] **company-og.jpg** - 회사 소개
- [ ] **partners-og.jpg** - 파트너사
- [ ] **contact-og.jpg** - 문의 페이지

**📁 저장 위치:** public/images/og/
**⚠️ 폴더 생성 필요:** 아직 존재하지 않음

---

## 📝 다운로드 가이드

### Unsplash 이미지 다운로드 방법
1. 링크 클릭하여 Unsplash 접속
2. 원하는 이미지 선택
3. "Download free" 버튼 클릭
4. 다운로드 후 파일명 변경
5. 해당 폴더에 저장

### 로고 다운로드 방법
1. 공식 웹사이트 방문
2. CI/BI 또는 Press Kit 섹션 찾기
3. PNG 형식 (투명 배경) 다운로드
4. 크기 조정: 200x100px 내외
5. 해당 폴더에 저장

### 이미지 최적화
- **도구:** TinyPNG (https://tinypng.com), ImageOptim
- **JPG:** 품질 80-85% 권장
- **PNG:** 8-bit 또는 24-bit (투명 배경 필요 시)
...
### 파트너사 정보
- [CASTANET SA Official](http://www.castanet-sa.fr/en/home)
- [SPX FLOW Brand Assets](https://brandfetch.com/spxflow.com)
- [NEUMAN & ESSER](https://www.neuman-esser.com/en/)
- [NIDEC Corporation](https://www.nidec.com/en/)

### 고객사 정보
- [SK에너지 CI](https://www.skenergy.com/company/ci?curTab=init)
- [S-OIL CI](https://www.s-oil.com/company/CI.aspx)
- [GS칼텍스 CI](https://www.gscaltex.com/kr/company/brand/ci)
- [HD현대오일뱅크](https://www.oilbank.co.kr)

### 무료 이미지
- [Unsplash - Oil Refinery](https://unsplash.com/s/photos/oil-refinery)
- [Unsplash - Industrial Equipment](https://unsplash.com/s/photos/industrial-equipment)
- [Unsplash - Shipyard](https://unsplash.com/s/photos/shipyard)
- [Unsplash - Compressor](https://unsplash.com/s/photos/compressor)
