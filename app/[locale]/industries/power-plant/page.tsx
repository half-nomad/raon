...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    keywords: isKorean
      ? ['발전소', '발전 플랜트', 'Power Plant', '압축기', 'Compressor', 'Motor', 'Bearing', '터빈']
      : ['Power Plant', 'power generation', 'turbine', 'compressor', 'motor', 'bearing', 'industrial equipment'],
    openGraph: {
      title: `${t('powerPlant.title')} | ${t('siteName')}`,
      description: t('powerPlant.description'),
